      ...
      <Card className="p-8 bg-white rounded-3xl border-0 shadow-lg mb-8">
        ...
        <div className="space-y-4">
          <Button
            ...
            className="w-full py-8 text-xl font-bold bg-[#4A7C59] hover:bg-[#3d694a] rounded-2xl"
          >
          ...
          <Button
            ...
            className="w-full py-8 text-xl font-bold border-2 border-[#4A7C59] text-[#4A7C59] hover:bg-[#F7F3EA] rounded-2xl"
          >
